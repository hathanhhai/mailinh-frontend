...
<template>
  <div>
    <div class="block">
      <PageHeader title="Báo cáo xe hôm nay" tooltip="Báo cáo xe hôm nay">
      </PageHeader>
      ...
      <NGrid class="report !gap-6" gap="12" :cols="3">
        ...
        <NGi>
          <div class="box-report">
            ...
            <div class="box-b">
              <p class="box-t">Tổng Xe đang di chuyển</p>
              <div class="box-c">
                <p class="text-primary">
                  100
                </p>
        ...
        <table class="table-auto border w-full">
          <thead>
            <tr>
              ...
              <th class="w-[220px] !text-left">Tài xế</th>
          ...
          <tbody>
            <tr>
              ...
              <td class="!text-left">
                <NTag type="success" size="small"><strong>47E-45678</strong></NTag> TP.HCM
                <br>
            ...
            <tr>
              ...
              <td class="!text-left">
                <NTag type="success" size="small"><strong>47E-45678</strong></NTag> TP.HCM
                <br>
                <strong>Huyndai - 5 chỗ - Đen</strong>
              </td>
              <td class="!text-left">
                Đỗ Trung Minh <br>
                039994567
              ...
              <td class="!text-center">
                <NTag round :bordered="false" size="small" type="primary">
                  Đang rảnh
                </NTag>
              </td>
              <td>
            ...
            <tr>
              ...
              <td class="!text-left">
                <NTag type="success" size="small"><strong>32E-45678</strong></NTag> Bình Dương<br>
                <strong>Huyndai - 5 chỗ - Đen</strong>
              </td>
              <td class="!text-left">
                Nguyễn Tuấn Vũ <br>
            ...
            <tr>
              ...
              <td class="!text-center">
                <NTag round :bordered="false" size="small" type="error">
                  Đang bảo dưỡng
                </NTag>
              </td>
              <td>
