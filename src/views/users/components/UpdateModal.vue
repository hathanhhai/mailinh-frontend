...
<template>
  <NSpace item-style="width: 450px;" class="320-500:w-[320px]">
      ...
      >
        ...
        <NFormItem path="role" :label="$t('pages.users.table.role')">
          <NSelect
            ...
            :options="roleOptions"
            :disabled="!authStore.isHasPermission(['RoleUpdate'])"
          />
        </NFormItem>
        ...
        <div class="flex justify-end">
          <NButton
            ...
            attr-type="submit"
          >
            <span class="mr-[4px]"> <Icon icon="material-symbols:save" /> </span>
            {{ $t('buttons.save') }}
          </NButton>
        </div>
      </NForm>
