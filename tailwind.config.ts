...
export default {
  ...
  theme: {
    extend: {
      ...
      screens: {
        '320-500': { min: '320px', max: '500px' },
        '320-767': { min: '320px', max: '767px' },
        '320-991': { min: '320px', max: '991px' },

        '320-400': { min: '325px', max: '400px' },
        '400-500': { min: '400px', max: '500px' },
        '500-767': { min: '500px', max: '767px' },
        '767-991': { min: '767px', max: '991px' },

        '991-1240': { min: '991px', max: '1240px' }
      },
      overflow: {
        overlay: 'overlay'
      }
